...
const ut=(e,t,A)=>{for(const A of t)if(A[0]===e)return(0,A[1])();return A?.()};class Et{constructor(e,t,A,i){this.hass=e,this.currentSection=t,this.card=A,this.config=i}async callMediaService(e,t){this.card.dispatchEvent(tt(qe,{section:this.currentSection}));try{await this.hass.callService("media_player",e,t)}finally{this.card.dispatchEvent(tt(Ze))}}async browseMedia(e,t,A){var i;const s=await this.hass.callWS({type:"media_player/browse_media",entity_id:e.id,media_content_id:A,media_content_type:t});return this.config.replaceHttpWithHttpsForThumbnails&&(s.children=null===(i=s.children)||void 0===i?void 0:i.map((e=>{var t;return Object.assign(Object.assign({},e),{thumbnail:null===(t=e.thumbnail)||void 0===t?void 0:t.replace("http://","https://")})}))),s}async getRelatedEntities(e,...t){return new Promise((async(A,i)=>{const s={type:"render_template",template:"{{ device_entities(device_id('"+e.id+"')) }}"};try{const e=await this.hass.connection.subscribeMessage((i=>{e(),A(i.result.filter((e=>t.some((t=>e.includes(t))))).map((e=>this.hass.states[e])))}),s)}catch(e){i(e)}}))}}const Bt="data:image/png;base64,";function Qt(e,t){for(const A in e)if(pt(A)===pt(t))return e[A]}function pt(e){return e.replace(/[^a-zA-Z ]/g,"")}function mt(e,t){let A=-1;return e.forEach(((e,i)=>{pt(e)===pt(t)&&(A=i)})),A}function vt(e,t){const A=e.some((e=>e.thumbnail));return e.map((e=>{const i=function(e,t,A){var i,s;let o=null!==(i=Qt(t.customThumbnail,e.title))&&void 0!==i?i:e.thumbnail;return o?(null==o?void 0:o.match(/https:\/\/brands\.home-assistant\.io\/.+\/logo.png/))&&(o=null==o?void 0:o.replace("logo.png","icon.png")):(o=Qt(t.customThumbnailIfMissing,e.title),A&&!o&&(o=(null===(s=t.customThumbnailIfMissing)||void 0===s?void 0:s.default)||Bt)),o||""}(e,t,A);return Object.assign(Object.assign({},e),{thumbnail:i})}))}function ft(e,t=!0){return j`
  ...
  `}class yt{constructor(e,t){this.hassService=e,this.config=t}async getFavorites(e){if(!e)return[];let t=await this.getFavoritesForPlayer(e);return t=t.flatMap((e=>e)),t=this.removeDuplicates(t),t=t.length?t:this.getFavoritesFromStates(e),t.filter((e=>{var t;return-1===mt(null!==(t=this.config.favoritesToIgnore)&&void 0!==t?t:[],e.title)}))}removeDuplicates(e){return e.filter(((e,t,A)=>t===A.findIndex((t=>t.title===e.title))))}async getFavoritesForPlayer(e){var t;try{const A=null===(t=(await this.hassService.browseMedia(e,"favorites","")).children)||void 0===t?void 0:t.map((t=>this.hassService.browseMedia(e,t.media_content_type,t.media_content_id)));return(A?await Promise.all(A):[]).flatMap((e=>{var t;return null!==(t=e.children)&&void 0!==t?t:[]}))}catch(t){return console.error(`Sonos Card: error getting favorites for player ${e.id}: ${JSON.stringify(t)}`),[]}}getFavoritesFromStates(e){return(e.attributes.hasOwnProperty("source_list")?e.attributes.source_list:[]).map((e=>({title:e})))}}class Ct{constructor(e,t){this.hassService=e,this.config=t}async join(e,t){await this.hassService.callMediaService("join",{entity_id:e,group_members:t})}async unJoin(e){await this.hassService.callMediaService("unjoin",{entity_id:e})}async setVolumeAndMediaForPredefinedGroup(e){var t;for(const A of e.entities){const i=null!==(t=A.volume)&&void 0!==t?t:e.volume;i&&await this.volumeSetSinglePlayer(A.player,i),e.unmuteWhenGrouped&&await this.setVolumeMute(A.player,!1,!1)}e.media&&await this.setSource(e.entities[0].player,e.media)}async volumeDown(e,t=!0){await this.volumeStep(e,t,this.getStepDownVolume,"volume_down")}async volumeUp(e,t=!0){await this.volumeStep(e,t,this.getStepUpVolume,"volume_up")}async volumeStep(e,t,A,i){this.config.volumeStepSize?await this.volumeWithStepSize(e,t,this.config.volumeStepSize,A):await this.volumeDefaultStep(e,t,i)}async volumeWithStepSize(e,t,A,i){for(const s of e.members)if(e.id===s.id||t){const e=i(s,A);await this.volumeSetSinglePlayer(s,e)}}getStepDownVolume(e,t){return Math.max(0,e.getVolume()-t)}getStepUpVolume(e,t){return Math.min(100,e.getVolume()+t)}async volumeDefaultStep(e,t,A){for(const i of e.members)(e.id===i.id||t)&&(i.ignoreVolume||await this.hassService.callMediaService(A,{entity_id:i.id}))}async volumeSet(e,t,A){return A?await this.volumeSetGroup(e,t):await this.volumeSetSinglePlayer(e,t)}async volumeSetGroup(e,t){let A;this.config.adjustVolumeRelativeToMainPlayer&&(A=t/e.getVolume()),await Promise.all(e.members.map((e=>{let i=t;return void 0!==A&&this.config.adjustVolumeRelativeToMainPlayer&&(i=e.getVolume()*A,i=Math.min(100,Math.max(0,i))),this.volumeSetSinglePlayer(e,i)})))}async volumeSetSinglePlayer(e,t){if(!e.ignoreVolume){const A=t/100;await this.hassService.callMediaService("volume_set",{entity_id:e.id,volume_level:A})}}async toggleMute(e,t=!0){const A=!e.isMuted(t);await this.setVolumeMute(e,A,t)}async setVolumeMute(e,t,A=!0){for(const i of e.members)(e.id===i.id||A)&&await this.hassService.callMediaService("volume_mute",{entity_id:i.id,is_volume_muted:t})}async setSource(e,t){await this.hassService.callMediaService("select_source",{source:t,entity_id:e.id})}async playMedia(e,t){await this.hassService.callMediaService("play_media",{entity_id:e.id,media_content_id:t.media_content_id,media_content_type:t.media_content_type})}async seek(e,t){await this.hassService.callMediaService("media_seek",{entity_id:e.id,seek_position:t})}}class bt{constructor(e,t,A){var i;this.id=e.entity_id,this.config=t,this.name=this.getEntityName(e,t),this.state=e.state,this.attributes=e.attributes,this.members=A?this.createGroupMembers(e,A):[this],this.volumePlayer=this.determineVolumePlayer(),this.ignoreVolume=!!(null===(i=this.config.entitiesToIgnoreVolumeLevelFor)||void 0===i?void 0:i.includes(this.volumePlayer.id))}getMember(e){return this.members.find((t=>t.id===e))}hasMember(e){return void 0!==this.getMember(e)}isPlaying(){return"playing"===this.state}isMuted(e){return this.attributes.is_volume_muted&&(!e||this.members.every((e=>e.isMuted(!1))))}getCurrentTrack(){var e,t;let A=`${this.attributes.media_artist||""} - ${this.attributes.media_title||""}`;return A=A.replace(/^ - | - $/g,""),A||(A=null!==(t=null===(e=this.attributes.media_content_id)||void 0===e?void 0:e.replace(/.*:\/\//g,""))&&void 0!==t?t:""),A}getEntityName(e,t){const A=e.attributes.friendly_name||"";return t.entityNameRegexToReplace?A.replace(new RegExp(t.entityNameRegexToReplace,"g"),t.entityNameReplacement||""):A}createGroupMembers(e,t){return st(e).reduce(((e,A)=>{const i=t.find((e=>e.entity_id===A));return i?[...e,new bt(i,this.config)]:e}),[])}determineVolumePlayer(){let e;return this.members.length>1&&this.config.entitiesToIgnoreVolumeLevelFor&&(e=this.members.find((e=>{var t;return!(null===(t=this.config.entitiesToIgnoreVolumeLevelFor)||void 0===t?void 0:t.includes(e.id))}))),null!=e?e:this}getVolume(){let e;return e=this.members.length>1&&this.config.adjustVolumeRelativeToMainPlayer?this.getAverageVolume():100*this.volumePlayer.attributes.volume_level,Math.round(e)}getAverageVolume(){const e=this.members.filter((e=>{var t;return!(null===(t=this.config.entitiesToIgnoreVolumeLevelFor)||void 0===t?void 0:t.includes(e.id))})).map((e=>e.attributes.volume_level));return 100*e.reduce(((e,t)=>e+t),0)/e.length}}const{TURN_OFF:It,TURN_ON:wt}=he;class Pt{constructor(e,t,A,i,s){this.hass=e,this.config=t;const o=this.getMediaPlayerHassEntities(this.hass);this.allGroups=this.createPlayerGroups(o),this.allMediaPlayers=this.allGroups.reduce(((e,t)=>[...e,...t.members]),[]).sort(((e,t)=>e.name.localeCompare(t.name))),this.activePlayer=this.determineActivePlayer(s),this.hassService=new Et(this.hass,A,i,t),this.mediaControlService=new Ct(this.hassService,t),this.mediaBrowseService=new yt(this.hassService,t),this.predefinedGroups=this.createPredefinedGroups()}createPredefinedGroups(){const e=[];if(this.config.predefinedGroups)for(const t of this.config.predefinedGroups){const A=this.createPredefinedGroup(t);A&&e.push(A)}return e}createPredefinedGroup(e){let t;const A=[];let i=e.entities;e.excludeItemsInEntitiesList&&(i=this.convertExclusionsInPredefinedGroupsToInclusions(i));for(const e of i){const t=this.createPredefinedGroupPlayer(e);t&&A.push(t)}return A.length&&(t=Object.assign(Object.assign({},e),{entities:A})),t}convertExclusionsInPredefinedGroupsToInclusions(e){return this.allMediaPlayers.filter((t=>!e.find((e=>("string"==typeof e?e:e.player)===t.id)))).map((e=>e.id))}createPredefinedGroupPlayer(e){var t;let A,i,s;if("string"==typeof e?A=e:(i=e.volume,A=e.player),"unavailable"!==(null===(t=this.hass.states[A])||void 0===t?void 0:t.state)){const e=this.allMediaPlayers.find((e=>e.id===A));e&&(s={player:e,volume:i})}else console.warn(`Player ${A} is unavailable`);return s}getMediaPlayerHassEntities(e){const t=e,A=Object.values(e.states).filter((e=>!!e.entity_id.includes("media_player")&&(ot(this.config)?function(e,t,A){var i,s;const o=[...new Set(e.entities)];let r=!0;if(o.length){const A=o.includes(t.entity_id);r=!!e.excludeItemsInEntitiesList!==A}let n=!0;e.entityPlatform&&(n=(null===(s=null===(i=A.entities)||void 0===i?void 0:i[t.entity_id])||void 0===s?void 0:s.platform)===e.entityPlatform);return r&&n}(this.config,e,t):function(e,t,A){var i,s;const o=[...new Set(e.entities)];if(e.entityPlatform)return(null===(s=null===(i=A.entities)||void 0===i?void 0:i[t.entity_id])||void 0===s?void 0:s.platform)===e.entityPlatform;if(o.length){const A=o.includes(t.entity_id);return!!e.excludeItemsInEntitiesList!==A}return!1}(this.config,e,t))));return function(e,t){return e.entities?t.sort(((t,A)=>{var i,s,o,r;return(null!==(s=null===(i=e.entities)||void 0===i?void 0:i.indexOf(t.entity_id))&&void 0!==s?s:-1)-(null!==(r=null===(o=e.entities)||void 0===o?void 0:o.indexOf(A.entity_id))&&void 0!==r?r:-1)})):t.sort(((e,t)=>e.entity_id.localeCompare(t.entity_id)))}(this.config,A)}createPlayerGroups(e){return e.filter((t=>this.isMainPlayer(t,e))).map((t=>this.createPlayerGroup(t,e))).filter((e=>void 0!==e))}isMainPlayer(e,t){var A;try{const i=st(e).filter((e=>t.some((t=>t.entity_id===e)))),s=(null==i?void 0:i.length)>1,o=s&&i&&i[0]===e.entity_id,r="unavailable"!==(null===(A=this.hass.states[e.entity_id])||void 0===A?void 0:A.state);return r||console.warn(`Player ${e.entity_id} is unavailable`),(!s||o)&&r}catch(t){return console.error("Failed to determine main player",JSON.stringify(e),t),!1}}createPlayerGroup(e,t){try{return new bt(e,this.config,t)}catch(t){return void console.error("Failed to create group",JSON.stringify(e),t)}}determineActivePlayer(e){const t=e||this.config.entityId||this.getActivePlayerFromUrl();return this.allGroups.find((e=>void 0!==e.getMember(t)))||this.allGroups.find((e=>e.isPlaying()))||this.allGroups[0]}getActivePlayerFromUrl(){return window.location.href.includes("#")?window.location.href.replace(/.*#/g,""):""}showPower(e=!1){return this.config.hidePlayerControlPowerButton?[]:((this.activePlayer.attributes.supported_features||0)&Ke)!=Ke||e&&"off"!==this.activePlayer.state?[]:[wt,It]}}class St extends se{render(){return j`<ha-icon-button
    ...
    `}});const jt=[{type:"string",name:"entityNameRegexToReplace"},{type:"string",name:"entityNameReplacement"},{type:"boolean",name:"excludeItemsInEntitiesList"}],Gt=[{name:"entityId",help:"Not needed, but forces this player to be the selected one on loading the card (overrides url param etc)",selector:{entity:{multiple:!1,filter:{domain:"media_player"}}}},{name:"entities",help:"Required, unless you have specified entity platform",cardType:"maxi",selector:{entity:{multiple:!0,filter:{domain:"media_player"}}}},{name:"entities",help:"Not needed, unless you don't want to include all of them",cardType:"sonos",selector:{entity:{multiple:!0,filter:{domain:"media_player"}}}},{name:"showNonSonosPlayers",help:"Show all media players, including those that are not on the Sonos platform",cardType:"sonos",selector:{boolean:{}}}];class Wt extends Ht{constructor(){super(...arguments),this.entitiesSchema=Gt}render(){const e=this.config.predefinedGroups;return this.entitiesSchema=Gt.filter((e=>void 0===e.cardType||this.config.type.indexOf(e.cardType)>-1)),this.editGroup>-1?j`<sonos-card-predefined-group-editor
      ...
      <ha-control-button-group>
        ...
        <ha-control-button @click=${this.deletePredefinedGroup}>
          Delete<ha-svg-icon .path=${ue} label="Delete"></ha-svg-icon>
        </ha-control-button>
      </ha-control-button-group>
    ...
    `}valueChanged(e){const t=e.detail.value;this.config=Object.assign(Object.assign({},this.config),t),this.configChanged()}}function Ft({help:e,label:t,name:A}){if(t)return t;let i=A.replace(/([A-Z])/g," $1");return i=i.charAt(0).toUpperCase()+i.slice(1),i+(e?` (${e})`:"")}e([ae({attribute:!1})],Yt.prototype,"schema",void 0),e([ae({attribute:!1})],Yt.prototype,"data",void 0),e([ae()],Yt.prototype,"changed",void 0),customElements.define("sonos-card-editor-form",Yt);const{GENERAL:Kt,ENTITIES:$t,ADVANCED:_t,ARTWORK:eA}=Tt;class tA extends Ht{constructor(){super(...arguments),this.configArea=Kt}render(){return this.config.sections&&0!==this.config.sections.length||(this.config.sections=[de.PLAYER,de.VOLUMES,de.GROUPS,de.GROUPING,de.MEDIA_BROWSER]),j`
      ...
      ${this.subEditor()}
    `}subEditor(){return ut(this.configArea,[[Kt,()=>j`<sonos-card-general-editor .config=${this.config} .hass=${this.hass}></sonos-card-general-editor>`],[$t,()=>j`<sonos-card-entities-editor .config=${this.config} .hass=${this.hass}></sonos-card-entities-editor>`],[_t,()=>j`<sonos-card-advanced-editor .config=${this.config} .hass=${this.hass}></sonos-card-advanced-editor>`],[eA,()=>j`<sonos-card-artwork-overrides-editor
            .config=${this.config}
            .hass=${this.hass}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function AA(e,t,A){return e?t(e):A?.(e)}e([le()],tA.prototype,"configArea",void 0),customElements.define("sonos-card-editor",tA);const iA=function(){const{width:e,height:t}=window.screen,A=window.screen.orientation.type.startsWith("portrait")?"portrait":"landscape";return"portrait"===A&&e<600&&534!=e||"landscape"===A&&t<600&&534!=t?"phone":"tablet"}(),{GROUPING:sA,GROUPS:oA,MEDIA_BROWSER:rA,PLAYER:nA,VOLUMES:aA}=de;class lA extends se{constructor(){super(...arguments),this.showSectionListener=e=>{const t=e.detail;(!this.config.sections||this.config.sections.indexOf(t)>-1)&&(this.section=t)},this.callMediaStartedListener=e=>{this.showLoader||this.config.sections&&e.detail.section!==this.section||(this.cancelLoader=!1,setTimeout((()=>{this.cancelLoader||(this.showLoader=!0,this.loaderTimestamp=Date.now())}),300))},this.callMediaDoneListener=()=>{this.cancelLoader=!0;const e=Date.now()-this.loaderTimestamp;this.showLoader&&(e<1e3?setTimeout((()=>this.showLoader=!1),1e3-e):this.showLoader=!1)},this.activePlayerListener=e=>{var t;const A=e.detail.entityId;A!==this.activePlayerId&&(this.activePlayerId=A,(null===(t=this.config.sections)||void 0===t?void 0:t.includes(nA))&&(this.section=nA),this.requestUpdate())},this.onMediaItemSelected=()=>{var e;(null===(e=this.config.sections)||void 0===e?void 0:e.includes(nA))&&setTimeout((()=>this.section=nA),1e3)}}render(){this.createStore();let e=it(this.config);const t=this.config.sections,A=!t||t.length>1,i=A?e-5:e,s=this.config.title;return e=s?e+2:e,j`
      <ha-card style=${this.haCardStyle(e)}>
        ...
        <div class="content" style=${this.contentStyle(i)}>
          ${this.activePlayerId?ut(this.section,[[nA,()=>j` <sonos-player .store=${this.store}></sonos-player>`],[oA,()=>j` <sonos-groups
                        .store=${this.store}
                        @active-player=${this.activePlayerListener}
                      ></sonos-groups>`],[sA,()=>j`<sonos-grouping
                        .store=${this.store}
                        @active-player=${this.activePlayerListener}
                      ></sonos-grouping>`],[rA,()=>j`
                      <sonos-media-browser
                      ...
                      ></sonos-media-browser>
                    `],[aA,()=>j` <sonos-volumes .store=${this.store}></sonos-volumes>`]]):j`<div class="no-players">No supported players found</div>`}
        </div>
        ${AA(A,(()=>j`<sonos-footer
    ...
    `}}e([ae({attribute:!1})],lA.prototype,"hass",void 0),e([ae({attribute:!1})],lA.prototype,"config",void 0),e([le()],lA.prototype,"section",void 0),e([le()],lA.prototype,"store",void 0),e([le()],lA.prototype,"showLoader",void 0),e([le()],lA.prototype,"loaderTimestamp",void 0),e([le()],lA.prototype,"cancelLoader",void 0),e([le()],lA.prototype,"activePlayerId",void 0);class cA extends se{render(){const e=!!this.icon&&!!this.name||W;return j`
    ...
    `}static get styles(){return[Ye,r`
      ...
      `]}toggleItem(e){e.isDisabled||this.toggleItemWithoutDisabledCheck(e)}toggleItemWithoutDisabledCheck(e){this.modifiedItems.includes(e.player.id)?this.modifiedItems=this.modifiedItems.filter((t=>t!==e.player.id)):this.modifiedItems=[...this.modifiedItems,e.player.id],this.selectedPredefinedGroup=void 0}async applyGrouping(){const e=this.groupingItems,t=this.joinedPlayers,A=this.activePlayer.id,{unJoin:i,join:s,newMainPlayer:o}=function(e,t,A){const i=e.filter((e=>e.isSelected)),s=e.filter((e=>!e.isSelected&&t.includes(e.player.id))).map((e=>e.player.id)),o=e.filter((e=>e.isSelected&&!t.includes(e.player.id))).map((e=>e.player.id));let r=A;return s.includes(A)&&(r=i[0].player.id),{unJoin:s,join:o,newMainPlayer:r}}(e,t,A);s.length>0&&await this.mediaControlService.join(o,s),i.length>0&&await this.mediaControlService.unJoin(i),this.selectedPredefinedGroup&&await this.mediaControlService.setVolumeAndMediaForPredefinedGroup(this.selectedPredefinedGroup),o===A||this.config.dontSwitchPlayerWhenGrouping||_e(o,this.config,this),this.config.entityId&&i.includes(this.config.entityId)&&this.config.dontSwitchPlayerWhenGrouping&&_e(this.config.entityId,this.config,this),this.modifiedItems=[],this.selectedPredefinedGroup=void 0}cancelGrouping(){this.modifiedItems=[]}getGroupingItems(){const e=this.store.allMediaPlayers.map((e=>new dA(e,this.activePlayer,this.modifiedItems.includes(e.id)))),t=e.filter((e=>e.isSelected));return 1===t.length&&(t[0].isDisabled=!0),e.sort(((e,t)=>e.isMain&&!t.isMain||e.isSelected&&!t.isSelected?-1:e.name.localeCompare(t.name))),e}renderJoinAllButton(){var e,t;const A=null!==(t=null===(e=this.config.groupingButtonIcons)||void 0===e?void 0:e.joinAll)&&void 0!==t?t:"mdi:checkbox-multiple-marked-outline";return AA(this.notJoinedPlayers.length,(()=>this.groupingButton(A,this.selectAll)))}groupingButton(e,t){return j` <sonos-grouping-button @click=${t} .icon=${e}></sonos-grouping-button> `}getNotJoinedPlayers(){return this.mediaPlayerIds.filter((e=>e!==this.activePlayer.id&&!this.activePlayer.hasMember(e)))}renderUnJoinAllButton(){var e,t;const A=null!==(t=null===(e=this.config.groupingButtonIcons)||void 0===e?void 0:e.unJoinAll)&&void 0!==t?t:"mdi:minus-box-multiple-outline";return AA(this.joinedPlayers.length,(()=>this.groupingButton(A,this.deSelectAll)))}getJoinedPlayers(){return this.mediaPlayerIds.filter((e=>e===this.activePlayer.id||this.activePlayer.hasMember(e)))}renderPredefinedGroups(){return this.store.predefinedGroups.map((e=>{var t,A,i;return j`
        ...
        ></sonos-grouping-button>
      `}))}selectPredefinedGroup(e){this.groupingItems.forEach((async t=>{const A=e.entities.some((e=>e.player.id===t.player.id));(A&&!t.isSelected||!A&&t.isSelected)&&this.toggleItemWithoutDisabledCheck(t)})),this.selectedPredefinedGroup=e}selectAll(){this.groupingItems.forEach((e=>{e.isSelected||this.toggleItem(e)}))}deSelectAll(){this.groupingItems.forEach((e=>{(!e.isMain&&e.isSelected||e.isMain&&!e.isSelected)&&this.toggleItem(e)}))}}e([ae({attribute:!1})],hA.prototype,"store",void 0),e([le()],hA.prototype,"modifiedItems",void 0),e([le()],hA.prototype,"selectedPredefinedGroup",void 0);class gA extends se{constructor(){super(...arguments),this.selected=!1,this.dispatchEntityIdEvent=()=>{if(this.selected){_e(this.player.id,this.store.config,this)}}}render(){const e=this.store.config.hideGroupCurrentTrack?"":this.player.getCurrentTrack(),t=$e(this.player,this.store.predefinedGroups),A=this.player.members.map((e=>e.attributes.icon)).filter((e=>e));return j`
      <mwc-list-item
        hasMeta
    ...
    `}}e([ae({attribute:!1})],gA.prototype,"store",void 0),e([ae({attribute:!1})],gA.prototype,"player",void 0),e([ae({type:Boolean})],gA.prototype,"selected",void 0),customElements.define("sonos-group",gA);class uA extends se{render(){return this.activePlayer=this.store.activePlayer,this.groups=this.store.allGroups,j`
    ...
    `}static get styles(){return Ye}}e([ae({attribute:!1})],uA.prototype,"store",void 0);class EA extends se{render(){return this.config=this.store.config,j`
    ...
    `}static get styles(){return[r`
      ...
      `,Fe,Ye]}}e([ae({attribute:!1})],EA.prototype,"store",void 0),e([ae({type:Array})],EA.prototype,"items",void 0),customElements.define("sonos-media-browser-list",EA);class BA extends se{render(){return this.config=this.store.config,j`
      <div class="icons">
        ${vt(this.items,this.config).map((e=>j`
            <ha-control-button
    ...
    `}buttonStyle(e){const t=`calc(100% / ${e} - 1% * 3)`;return lt({width:t,height:t,margin:"1%"})}static get styles(){return[Fe,r`
        .icons {
          display: flex;
          flex-wrap: wrap;
          justify-content: center;
      ...
      `]}}e([ae({attribute:!1})],BA.prototype,"store",void 0),e([ae({attribute:!1})],BA.prototype,"items",void 0),customElements.define("sonos-media-browser-icons",BA);class QA extends se{render(){var e;return j`
    ...
    `}}e([ae({attribute:!1})],QA.prototype,"store",void 0),customElements.define("sonos-media-browser-header",QA);class pA extends se{constructor(){super(...arguments),this.onMediaItemSelected=e=>{const t=e.detail;this.playItem(t),this.dispatchEvent(tt(Je,t))}}render(){return this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.mediaBrowseService=this.store.mediaBrowseService,this.mediaControlService=this.store.mediaControlService,j`
    ...
    `}}e([ae({attribute:!1})],vA.prototype,"store",void 0),e([le()],vA.prototype,"showSwitches",void 0),customElements.define("sonos-volumes",vA);class fA extends se{render(){const e=this.store.hass.states[this.store.activePlayer.id];let t=0;this.features.forEach((e=>t+=e));const A=Object.assign(Object.assign({},e),{attributes:Object.assign(Object.assign({},e.attributes),{supported_features:t})});return j` <more-info-content .stateObj=${A} .hass=${this.store.hass}></more-info-content> `}}e([ae({attribute:!1})],fA.prototype,"store",void 0),e([ae({attribute:!1})],fA.prototype,"features",void 0),customElements.define("sonos-ha-player",fA),window.customCards.push({type:"sonos-card",name:"Sonos",description:"Media player for your Sonos speakers",preview:!0}),customElements.define("sonos-card",lA),customElements.define("sonos-grouping",hA),customElements.define("sonos-groups",uA),customElements.define("sonos-media-browser",pA),customElements.define("sonos-player",gt);

 ...
 */
var _a;
const t$3 = globalThis, e$5 = t$3.ShadowRoot && (void 0 === t$3.ShadyCSS || t$3.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, s$3 = Symbol(), o$5 = /* @__PURE__ */ new WeakMap();
let n$7 = class n {
...
const r$8 = (t2) => new n$7("string" == typeof t2 ? t2 : t2 + "", void 0, s$3), i$7 = (t2, ...e2) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: i$6, defineProperty: e$4, getOwnPropertyDescriptor: r$7, getOwnPropertyNames: h$3, getOwnPropertySymbols: o$4, getPrototypeOf: n$6 } = Object, a$1 = globalThis, c$3 = a$1.trustedTypes, l$1 = c$3 ? c$3.emptyScript : "", p$1 = a$1.reactiveElementPolyfillSupport, d$1 = (t2, s2) => t2, u$1 = { toAttribute(t2, s2) {
  switch (s2) {
    case Boolean:
      t2 = t2 ? l$1 : null;
      break;
  ...
  return i4;
} }, f$3 = (t2, s2) => !i$6(t2, s2), y$1 = { attribute: true, type: String, converter: u$1, reflect: false, hasChanged: f$3 };
...
class b extends HTMLElement {
  ...
  static createProperty(t2, s2 = y$1) {
    if (s2.state && (s2.attribute = false), this._$Ei(), this.elementProperties.set(t2, s2), !s2.noAccessor) {
      const i4 = Symbol(), r3 = this.getPropertyDescriptor(t2, i4, s2);
      void 0 !== r3 && e$4(this.prototype, t2, r3);
    }
  }
  static getPropertyDescriptor(t2, s2, i4) {
    const { get: e2, set: h2 } = r$7(this.prototype, t2) ?? { get() {
      return this[s2];
    }, set(t3) {
      this[s2] = t3;
    } };
    return { get() {
      ...
      h2.call(this, s3), this.requestUpdate(t2, r3, i4);
  ...
  _$EC(t2, s2) {
    ...
    if (void 0 !== e2 && true === i4.reflect) {
      const r3 = (void 0 !== ((_a2 = i4.converter) == null ? void 0 : _a2.toAttribute) ? i4.converter : u$1).toAttribute(s2, i4.type);
  ...
  _$AK(t2, s2) {
    ...
    if (void 0 !== e2 && this._$Em !== e2) {
      const t3 = i4.getPropertyOptions(e2), r3 = "function" == typeof t3.converter ? { fromAttribute: t3.converter } : void 0 !== ((_a2 = t3.converter) == null ? void 0 : _a2.fromAttribute) ? t3.converter : u$1;
      this._$Em = e2, this[e2] = r3.fromAttribute(s2, t3.type), this._$Em = null;
    }
  }
  requestUpdate(t2, s2, i4) {
    if (void 0 !== t2) {
      if (i4 ?? (i4 = this.constructor.getPropertyOptions(t2)), !(i4.hasChanged ?? f$3)(this[t2], s2)) return;
      this.P(t2, s2, i4);
    }
    false === this.isUpdatePending && (this._$ES = this._$ET());
  }
  P(t2, s2, i4) {
    this._$AL.has(t2) || this._$AL.set(t2, s2), true === i4.reflect && this._$Em !== t2 && (this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Set())).add(t2);
  }
  async _$ET() {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (t3.size > 0) for (const [s3, i4] of t3) true !== i4.wrapped || this._$AL.has(s3) || void 0 === this[s3] || this.P(s3, this[s3], i4);
    }
    let t2 = false;
    const s2 = this._$AL;
    try {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$2 = globalThis, i$5 = t$2.trustedTypes, s$2 = i$5 ? i$5.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, e$3 = "$lit$", h$2 = `lit$${Math.random().toFixed(9).slice(2)}$`, o$3 = "?" + h$2, n$5 = `<${o$3}>`, r$6 = document, l = () => r$6.createComment(""), c$2 = (t2) => null === t2 || "object" != typeof t2 && "function" != typeof t2, a = Array.isArray, u = (t2) => a(t2) || "function" == typeof (t2 == null ? void 0 : t2[Symbol.iterator]), d = "[ 	\n\f\r]", f$2 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, v = /-->/g, _ = />/g, m$1 = RegExp(`>|${d}(?:([^\\s"'>=/]+)(${d}*=${d}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), p = /'/g, g = /"/g, $ = /^(?:script|style|textarea|title)$/i, y = (t2) => (i4, ...s2) => ({ _$litType$: t2, strings: i4, values: s2 }), x = y(1), T = Symbol.for("lit-noChange"), E = Symbol.for("lit-nothing"), A = /* @__PURE__ */ new WeakMap(), C = r$6.createTreeWalker(r$6, 129);
function P(t2, i4) {
...
const V = (t2, i4) => {
  ...
  let r3, l2 = 2 === i4 ? "<svg>" : 3 === i4 ? "<math>" : "", c2 = f$2;
  for (let i5 = 0; i5 < s2; i5++) {
    ...
    l2 += c2 === f$2 ? s3 + n$5 : d2 >= 0 ? (o2.push(a2), s3.slice(0, d2) + e$3 + s3.slice(d2) + h$2 + x2) : s3 + h$2 + (-2 === d2 ? i5 : x2);
  }
    ...
    for (; null !== (r3 = C.nextNode()) && d2.length < u2; ) {
      if (1 === r3.nodeType) {
        if (r3.hasAttributes()) for (const t3 of r3.getAttributeNames()) if (t3.endsWith(e$3)) {
          const i4 = v2[a2++], s3 = r3.getAttribute(t3).split(h$2), e2 = /([.?@])?(.*)/.exec(i4);
        ...
        if ($.test(r3.tagName)) {
          ...
          if (s3 > 0) {
            ...
            for (let i4 = 0; i4 < s3; i4++) r3.append(t3[i4], l()), C.nextNode(), d2.push({ type: 2, index: ++c2 });
            r3.append(t3[s3], l());
          }
        }
...
function S(t2, i4, s2 = t2, e2) {
  ...
  return (h2 == null ? void 0 : h2.constructor) !== o2 && ((_b = h2 == null ? void 0 : h2._$AO) == null ? void 0 : _b.call(h2, false), void 0 === o2 ? h2 = void 0 : (h2 = new o2(t2), h2._$AT(t2, s2, e2)), void 0 !== e2 ? (s2._$Co ?? (s2._$Co = []))[e2] = h2 : s2._$Cl = h2), void 0 !== h2 && (i4 = S(t2, h2._$AS(t2, i4.values), h2, e2)), i4;
}
class M {
  constructor(t2, i4) {
  ...
  u(t2) {
    const { el: { content: i4 }, parts: s2 } = this._$AD, e2 = ((t2 == null ? void 0 : t2.creationScope) ?? r$6).importNode(i4, true);
    C.currentNode = e2;
...
class R {
  ...
  constructor(t2, i4, s2, e2) {
    this.type = 2, this._$AH = E, this._$AN = void 0, this._$AA = t2, this._$AB = i4, this._$AM = s2, this.options = e2, this._$Cv = (e2 == null ? void 0 : e2.isConnected) ?? true;
  }
  get parentNode() {
  ...
  _(t2) {
    this._$AH !== E && c$2(this._$AH) ? this._$AA.nextSibling.data = t2 : this.T(r$6.createTextNode(t2)), this._$AH = t2;
  }
  $(t2) {
    var _a2;
  ...
  k(t2) {
    ...
    const i4 = this._$AH;
    let s2, e2 = 0;
    for (const h2 of t2) e2 === i4.length ? i4.push(s2 = new R(this.O(l()), this.O(l()), this, this.options)) : s2 = i4[e2], s2._$AI(h2), e2++;
...
class k {
  ...
  _$AI(t2, i4 = this, s2, e2) {
    ...
    if (void 0 === h2) t2 = S(this, t2, i4, 0), o2 = !c$2(t2) || t2 !== this._$AH && t2 !== T, o2 && (this._$AH = t2);
      ...
      const e3 = t2;
      let n3, r3;
      for (t2 = h2[0], n3 = 0; n3 < h2.length - 1; n3++) r3 = S(this, e3[s2 + n3], i4, n3), r3 === T && (r3 = this._$AH[n3]), o2 || (o2 = !c$2(r3) || r3 !== this._$AH[n3]), r3 === E ? t2 = E : t2 !== E && (t2 += (r3 ?? "") + h2[n3 + 1]), this._$AH[n3] = r3;
    }
    o2 && !e2 && this.j(t2);
  }
  j(t2) {
...
r$5._$litElement$ = true, r$5["finalized"] = true, (_a = globalThis.litElementHydrateSupport) == null ? void 0 : _a.call(globalThis, { LitElement: r$5 });
const i$4 = globalThis.litElementPolyfillSupport;
i$4 == null ? void 0 : i$4({ LitElement: r$5 });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const o$2 = { attribute: true, type: String, converter: u$1, reflect: false, hasChanged: f$3 }, r$4 = (t2 = o$2, e2, r3) => {
  const { kind: n3, metadata: i4 } = r3;
  let s2 = globalThis.litPropertyMetadata.get(i4);
  if (void 0 === s2 && globalThis.litPropertyMetadata.set(i4, s2 = /* @__PURE__ */ new Map()), s2.set(r3.name, t2), "accessor" === n3) {
    const { name: o2 } = r3;
    return { set(r4) {
 ...
 */
function r$3(r3) {
  return n$4({ ...r3, state: true, attribute: false });
}
/**
 * @license
 * Copyright 2017 Google LLC
...
const s$1 = (i4, t2) => {
  ...
  for (const i5 of e2) (_a2 = i5._$AO) == null ? void 0 : _a2.call(i5, t2, false), s$1(i5, t2);
  return true;
}, o$1 = (i4) => {
  let t2, e2;
  do {
...
function h$1(i4) {
  void 0 !== this._$AN ? (o$1(this), this._$AM = i4, r$2(this)) : this._$AM = i4;
}
function n$3(i4, t2 = false, e2 = 0) {
  const r3 = this._$AH, h2 = this._$AN;
  if (void 0 !== h2 && 0 !== h2.size) if (t2) if (Array.isArray(r3)) for (let i5 = e2; i5 < r3.length; i5++) s$1(r3[i5], false), o$1(r3[i5]);
  else null != r3 && (s$1(r3, false), o$1(r3));
  else s$1(this, i4);
}
const c$1 = (i4) => {
  i4.type == t$1.CHILD && (i4._$AP ?? (i4._$AP = n$3), i4._$AQ ?? (i4._$AQ = h$1));
};
class f extends i$2 {
  constructor() {
  ...
  _$AT(i4, t2, e2) {
    super._$AT(i4, t2, e2), r$2(this), this.isConnected = i4._$AU;
  }
  _$AO(i4, t2 = true) {
    var _a2, _b;
    i4 !== this.isConnected && (this.isConnected = i4, i4 ? (_a2 = this.reconnected) == null ? void 0 : _a2.call(this) : (_b = this.disconnected) == null ? void 0 : _b.call(this)), t2 && (s$1(this, i4), o$1(this));
  }
  setValue(t2) {
...
class c extends f {
  ...
  update(s2, i4) {
    ...
    for (let t2 = 0; t2 < i4.length && !(t2 > this._$Cwt); t2++) {
      ...
      t2 < r3 && s3 === e2[t2] || (this._$Cwt = h, r3 = 0, Promise.resolve(s3).then(async (t3) => {
...
`;
const mediaBrowserTitleStyle = i$7`
  .title {
    color: var(--secondary-text-color);
    font-weight: bold;
    padding: 0 0.5rem;
...
class PlayerControls extends r$5 {
  constructor() {
    super(...arguments);
...
class PlayerHeader extends r$5 {
  render() {
    this.config = this.store.config;
    this.activePlayer = this.store.activePlayer;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const n$1 = "important", i3 = " !" + n$1, o = e(class extends i$2 {
  constructor(t2) {
    var _a2;
  ...
  render(t2) {
    return Object.keys(t2).reduce((e2, r3) => {
      const s2 = t2[r3];
      return null == s2 ? e2 : e2 + `${r3 = r3.includes("-") ? r3 : r3.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g, "-$&").toLowerCase()}:${s2};`;
    }, "");
  }
  update(e2, [r3]) {
    ...
    for (const t2 in r3) {
      ...
      if (null != e3) {
        this.ft.add(t2);
        const r4 = "string" == typeof e3 && e3.endsWith(i3);
        t2.includes("-") || r4 ? s2.setProperty(t2, r4 ? e3.slice(0, -11) : e3, r4 ? n$1 : "") : s2[t2] = e3;
      }
    }
    return T;
  }
 ...
 */
const r$1 = (r3, o2, t2) => {
  for (const t3 of o2) if (t3[0] === r3) return (0, t3[1])();
...
class SectionButton extends r$5 {
  render() {
...
var ne = function(e2, t2, r3, n3) {
  n3 = n3 || {}, r3 = null == r3 ? {} : r3;
  var i4 = new Event(t2, { bubbles: void 0 === n3.bubbles || n3.bubbles, cancelable: Boolean(n3.cancelable), composed: void 0 === n3.composed || n3.composed });
  return i4.detail = r3, e2.dispatchEvent(i4), i4;
};
...
function getDeviceType() {
  ...
  if (orientation === "portrait" && width < 600 && width != 534 || orientation === "landscape" && height < 600 && height != 534) {
    return "phone";
  } else {
    return "tablet";
  }
...
class GroupingButton extends r$5 {
  render() {
...
class MediaBrowserList extends r$5 {
  render() {
    this.config = this.store.config;
    return x`
...
class MediaBrowserIcons extends r$5 {
  render() {
    this.config = this.store.config;
...
class MediaBrowserHeader extends r$5 {
  render() {
    return x`
...
const _MediaBrowser = class _MediaBrowser2 extends r$5 {
  constructor() {
    super(...arguments);
